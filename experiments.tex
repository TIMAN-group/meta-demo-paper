...
(Table~\ref{table:ir-map}). We use the standard TREC queries associated with
each dataset and score each system's search results with the standard
\texttt{trec\_eval} program\footnote{\url{http://trec.nist.gov/trec_eval/}}.

\todo{Note about parallel indexing with Lucene and Indri}
