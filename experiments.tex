...
\newcite{Manning:2011:CICLing}, LTag-Spinal is from
\newcite{Shen:2007:ACL}, and SCCN is from \newcite{Sogaard:2011:ACL-HLT}.
...
provide an SVM, so it is excluded from the comparisons\todo{Maybe use
MALLET's maxent classifier?}). Statistics for the
